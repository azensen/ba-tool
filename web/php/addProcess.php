...
//create process folder in projects/level/
$projectPath = $rootPath . $projectName . '/'; //'../../projects/'
$processPath = $projectPath . $levelName . '/' . $processName . '/'; // '../../projects/levelName/processName/
...
$fileDestination = $processPath . $fileNameOut;
